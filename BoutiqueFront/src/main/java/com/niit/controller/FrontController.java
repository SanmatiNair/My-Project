...
public class FrontController {
	...
	public String Address(Model M,HttpSession session) {
		...
		M.addAttribute("addresslist",billingAddressDAO.list(Integer.parseInt(session.getAttribute("usercartid").toString())));
		return "page";

	}

	@RequestMapping(value = "setaddress")
	public String setCategory(@Valid @ModelAttribute("address") BillingAddress address,BindingResult result, Model M,HttpSession session) {
